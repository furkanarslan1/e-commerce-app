...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 p-2">
        <Link to="categories/smartphones">
          <div className="flex bg-gray-400 min-h-[300px]   flex-col md:flex-row  text-white  items-center hover:cursor-pointer">
            <img
        ...
        <Link to="categories/laptops">
          <div className="flex bg-[#F3F5F4] min-h-[300px]  flex-col md:flex-row gap-15    text-white  items-center hover:cursor-pointer lg:pb-17">
            <img
        ...
        <Link to="categories/laptops">
          <div className="flex flex-col md:flex-row bg-[#181818] min-h-[300px]  gap-8   text-white  items-center hover:cursor-pointer lg:pb-23">
            <img
        ...
        <Link to="categories/beauty">
          <div className="flex flex-col md:flex-row bg-[#ECEDE8]  min-h-[300px] gap-8     text-white  items-center hover:cursor-pointer">
            <img
        ...
        <Link to="categories/home-decoration">
          <div className="flex flex-col md:flex-row bg-[#E7EAE5] min-h-[300px] gap-8  text-white  items-center hover:cursor-pointer lg:pb-6">
            <img
        ...
        <Link to="categories/kitchen-accessories">
          <div className="flex flex-col md:flex-row bg-[#E4E4E4] min-h-[300px] gap-8  text-white  items-center hover:cursor-pointer lg:pb-6">
            <img
      ...
      <div className="grid  grid-cols-2 md:grid-cols-2 lg:grid-cols-3  gap-4 p-2  overflow-hidden ">
        <Link to="sale/special-offer">
          <div className="flex items-center justify-center bg-gradient-to-r from-red-800 to-red-400 h-50 rounded-2xl ">
            <p className="text-white text-4xl rotate-150  hidden lg:block">
              <FaArrowLeftLong />
            </p>
            <p className="text-white text-4xl rotate-170 hidden lg:block  ">
              <FaArrowLeftLong />
            </p>
            <p className="text-white text-4xl rotate-160 hidden lg:block ">
              <FaArrowLeftLong />
            </p>
            <p className="font-extrabold text-2xl  text-center  text-white">
              Special Offer
            </p>
            <p className="text-white text-4xl rotate-20 hidden lg:block">
              <FaArrowLeftLong />
            </p>
            <p className="text-white text-4xl rotate-40 hidden lg:block ">
              <FaArrowLeftLong />
            </p>
            <p className="text-white text-4xl rotate-50  hidden lg:block">
              <FaArrowLeftLong />
            </p>
          </div>
        </Link>
        <Link to="sale/products-on-sale">
          <div className="flex items-center justify-center bg-gradient-to-r from-orange-600 to-orange-400 h-50 rounded-2xl">
            <p className="font-extrabold text-2xl  text-center  text-white">
              Products on Sale
            </p>
          </div>
        ...
        <Link to="sale/products-on-sale">
          <div className="flex items-center justify-center bg-gradient-to-r from-blue-900 to-blue-400 h-50 rounded-2xl">
            <p className="font-extrabold text-2xl  text-center  text-white">
              Limited Time Offer
            </p>
          </div>
        ...
        <Link to="sale/huge-sale">
          <div className="flex items-center justify-center bg-gradient-to-r from-green-900 to-green-400 h-50 rounded-2xl ">
            <p className="font-extrabold text-2xl  text-center  text-white">
              Huge Sale
            </p>
            <p className="text-white rotate-45  text-2xl lg:text-6xl font-extrabold pb-5 lg:pb-10">
              75%
            </p>
          </div>
        </Link>
